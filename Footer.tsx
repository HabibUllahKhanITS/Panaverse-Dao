        ...
        <>
            <div className=' md:flex align-middle gap-[30px] p-[60px] bg-black'>
                ...
                <div className=' md:w-1/4 mb-[20px] md:mb-[0px]'>
                    ...
                    <ul className=' text-gray-600 pt-[30px]'>
                        <li><Link href={'/'} className='  hover:text-white'>+92 344 7507869</Link></li>
                        <li><Link href={'/'} className='  hover:text-white'>habibwpress@gmail.com</Link></li>
            ...
            <div className='md:flex justify-between px-[60px] py-[10px] text-center'>
                <p className=' font-bold'>All Rights Reserved © | <br className='md:hidden' /><Link href='https://github.com/' target='_blank' > HABIB ULLAH KHAN </Link></p>
                <div>
